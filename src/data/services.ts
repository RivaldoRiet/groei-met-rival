...
export const services: Service[] = [
  // === MEEST POPULAIRE BASIS SERVICES ===
  {
    id: "instagram-likes",
  ...
  },
  {
    ...
    description: "Krijg echte Amerikaanse volgers die daadwerkelijk geïnteresseerd zijn in jouw content.",
    platform: "Instagram",
    price_per_unit: 0.007,
    minimum_order: 50,
    maximum_order: 100000,
  ...
  },
  {
    ...
    description: "Voeg levendige Nigeriaanse comments toe aan je posts! Deze authentieke comments maken je posts interactiever.",
    platform: "Instagram",
