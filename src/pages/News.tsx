...
const News = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Nieuws - BoostDirect | Social Media Marketing Updates</title>
        <meta 
          name="description" 
          content="Blijf op de hoogte van het laatste nieuws over social media marketing, platform updates en BoostDirect ontwikkelingen." 
        />
        <meta name="keywords" content="nieuws, social media, marketing, updates, trends, boostdirect" />
        <link rel="canonical" href="https://boostdirect.nl/nieuws" />
      </Helmet>
